...
### 新增页面
1. ✅ **减重速度选择页** (P13) - 0.5/1/1.5 kg per week
2. ✅ **Referral Code 输入页** (P21) - 可选输入
3. ✅ **ATT 追踪权限页** (P30) - App Tracking Transparency

### 流程优化
4. ✅ **付费墙后页面精简** - 从 6 页精简到 3 页
5. ✅ **伏笔问题移到 Loading 之前** - 现在是 P16-21

### 当前流程 (37 页)
```
P1-2:   品牌建立 (Launch, Welcome)
P3-8:   目标设定 (Name, Goal, Gender, Activity, Workout)
P9-15:  身体数据 (Age, Weight, Target, Speed, Height)
P16-21: 伏笔问题 (Acquisition, Experience, Barriers, Diet, Goals, Referral)
P22-27: 价值展示 (Loading, Result, Value Props, Scan Game)
P28-31: 权限请求 (Health, Notifications, ATT, Transition)
P32-34: 付费转化 (Paywall, Spin, Paywall with discount)
P35-37: 成功流程 (Celebration, Account, Final)
```
