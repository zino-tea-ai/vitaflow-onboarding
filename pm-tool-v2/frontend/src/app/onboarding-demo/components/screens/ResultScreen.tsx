...
export function ResultScreen({ config }: ResultScreenProps) {
  const { results, userData, nextStep, prevStep, currentStep, totalSteps } = useOnboardingStore()
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-baseline mt-2">
              <span className="text-[48px] font-bold text-white">
                <AnimatedNumber value={results.dailyCalories} />
              </span>
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <p className="text-white/80 text-[13px]">
                {isLosing && `Lose ${Math.abs(weightDiff)}kg by ${results.targetDate}`}
                {isGaining && `Gain ${Math.abs(weightDiff)}kg by ${results.targetDate}`}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-[24px] font-bold mt-1" style={{ color: '#2B2735' }}>
              <AnimatedNumber value={results.bmi} />
            </p>
          ...
          >
            ...
            <p className="text-[24px] font-bold mt-1" style={{ color: '#2B2735' }}>
              <AnimatedNumber value={results.tdee} />
            </p>
          ...
          >
            ...
            <p className="text-[24px] font-bold mt-1" style={{ color: '#2B2735' }}>
              {isLosing ? '-' : isGaining ? '+' : ''}{results.weeklyLoss}kg
            </p>
