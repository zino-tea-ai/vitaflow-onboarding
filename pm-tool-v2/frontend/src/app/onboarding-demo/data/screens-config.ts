...
export const screensConfig: ScreenConfig[] = [
  ...
  },
  {
    id: 31,
    type: 'game_spin',
    title: 'One more try, {{name}}! 🍀',
    subtitle: "Let's see if luck is on your side",
    phase: 'conversion',
    usePersonalization: true
  },
  {
  ...
  },
  {
    ...
    subtitle: "You'll lose your 50% discount if you leave now",
    phase: 'conversion',
    usePersonalization: true
  },
  
  // ============ Phase 9: 成功 + 账号 (P34-39) ============
  {
    id: 34,
    type: 'celebration',
  ...
  },
  {
    ...
    subtitle: 'We use bank-level encryption and never sell your information',
    phase: 'success'
  },
  {
    id: 36,
  ...
  },
  {
    id: 38,
    type: 'value_prop',
    title: 'Track. Learn. Transform.',
    subtitle: 'Join millions who achieved their goals with VitaFlow',
    phase: 'success'
  },
  {
    id: 39,
